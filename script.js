...
function updateMock() {
  ...
  if (level === 1) {
    ...
    if (level === 3) {
      ...
      text =
        mockeryText.level2To5[
          Math.floor(Math.random() * mockeryText.level2To5.length)
        ];
  } else if (level >= 6 && level <= 10) {
    if (level === 6) {
      text = mockeryText.level6To10[0];
    } else if (level === 7) {
      text = mockeryText.level6To10[1];
    } else if (level === 10) {
      text = mockeryText.level6To10[4];
    } else
      text =
        mockeryText.level6To10[
          Math.floor(Math.random() * mockeryText.level6To10.length)
        ];
    ...
    if (level === 11) {
      ...
      text =
        mockeryText.level11To15[
          Math.floor(Math.random() * mockeryText.level11To15.length)
        ];
  } else if (level >= 16 && level <= 20) {
    if (level === 16) {
      text = mockeryText.level16To20[0];
    } else if (level === 17) {
      text = mockeryText.level16To20[1];
    } else if (level === 19) {
      text = mockeryText.level16To20[3];
    } else if (level === 20) {
      text = mockeryText.level16To20[4];
    }
    text =
      mockeryText.level16To20[
        Math.floor(Math.random() * mockeryText.level16To20.length)
      ];
  } else {
    if (level === 21) {
    ...
    text =
      mockeryText.level21AndAbove[
        Math.floor(Math.random() * mockeryText.level21AndAbove.length)
      ];
  }
  mock.text(text);
}
